...
namespace Bug.Testcases.Dto
{
    ...
    public class UpdateTestcaseInput
    {
        ...
        public void AddValidationErrors(CustomValidationContext context)
        {
            ...
            {
                context.Results.Add(new ValidationResult("Both of AssignedPersonId and State can not be null in order to update a Testcase!", new[] { "AssignedPersonId", "State" }));
            }
        }

        public override string ToString()
        {
            return string.Format("[UpdateTestcaseInput > TestcaseId = {0}, AssignedPersonId = {1}, State = {2}]", Id, AssignedPersonId, State);
        }
